import { StyleSheet, Modal, Text, View, ScrollView, Image, Dimensions, TouchableOpacity, Alert } from 'react-native'
                    ...
                    onLyric ?
                        ...
                        <View style={styles.boxImage}>
                            <View style={styles.content}>
                                <Image source={CARD_PEPSI_2_1x} style={styles.image} />
                            </View>
                        </View>
                }
            </View>
            ...
            <View style={styles.boxMic}>
                {onStart ?
                    <TouchableOpacity style={styles.btnReact} onPress={() => onClick("refresh")}>
                        <Image source={ICON_REFRESH} style={styles.icon} />
                    </TouchableOpacity>
                    :
                    <View></View>
                }
                <TouchableOpacity style={styles.btnMic} onPress={clickStart}>
                    <Image source={CENTER_BUTTON_1_5X} style={styles.center} />
                </TouchableOpacity>
                {onStart ?
